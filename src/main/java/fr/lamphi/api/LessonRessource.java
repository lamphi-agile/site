...
public class LessonRessource {
	...
	static{
		...
		Lesson newLesson = new Lesson("Le C !", "Informatique",contenu, 1, userRessource.getUser(1), "0000-00-00 00:00:00", false);

		lessons.put(1, newLesson);
		

		Lesson newLesson2 = new Lesson("Le Java !", "Informatique",contenu, 2, userRessource.getUser(2), "0000-00-00 00:00:00", false);
